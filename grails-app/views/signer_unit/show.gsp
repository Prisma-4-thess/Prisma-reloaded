...
<html>
	...
	<body>
		...
		<div id="show-signer_unit" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:signer_unitInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${signer_unitInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
