...
<html>
	...
	<body>
		...
		<div id="edit-dictionaryItem" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${dictionaryItemInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${dictionaryItemInstance}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			<g:form url="[resource:dictionaryItemInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${dictionaryItemInstance?.version}" />
				<fieldset class="form">
