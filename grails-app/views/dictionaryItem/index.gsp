	...
	<body>
		...
		<div id="list-dictionaryItem" class="content scaffold-list" role="main">
			...
			<thead>
				...
				<tbody>
				<g:each in="${dictionaryItemInstanceList}" status="i" var="dictionaryItemInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
					
						<td><g:link action="show" id="${dictionaryItemInstance.id}">${fieldValue(bean: dictionaryItemInstance, field: "uid")}</g:link></td>
					
						<td>${fieldValue(bean: dictionaryItemInstance, field: "label")}</td>
			...
			<div class="pagination">
				<g:paginate total="${dictionaryItemInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
