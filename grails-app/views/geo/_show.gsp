        ...
        <tr class="palette-silver">
            ...
            <th>
                <g:if test="${geoInstance?.dimos}">
                    <g:message code="geo.dimos.label" default="Municipality"/>
                </g:if>
            </th>
            <th>
                <g:if test="${geoInstance?.newCat}">
                    <g:message code="geo.newCat.label" default="Category"/>
                </g:if>
            </th>
            <th>
                <g:if test="${geoInstance?.newSubCat}">
                    <g:message code="geo.newSubCat.label" default="Sub Category"/>
                </g:if>
            </th>
            <th>
            ...
            <th>
                <g:if test="${geoInstance?.tk}">
                    <g:message code="geo.tk.label" default="Postal Code"/>
                </g:if>
            </th>
            <th>
