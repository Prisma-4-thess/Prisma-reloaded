		...
		<div id="list-organization" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="fekIssue" title="${message(code: 'organization.fekIssue.label', default: 'Fek Issue')}" />
				...
				<g:each in="${organizationInstanceList}" status="i" var="organizationInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: organizationInstance, field: "label")}</td>
