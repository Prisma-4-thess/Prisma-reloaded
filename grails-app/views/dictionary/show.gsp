	...
	<body>
		...
		<div id="show-dictionary" class="content scaffold-show" role="main">
			...
			<ol class="property-list dictionary">
				...
				<g:if test="${dictionaryInstance?.uid}">
				<li class="fieldcontain">
					<span id="uid-label" class="property-label"><g:message code="dictionary.uid.label" default="Uid" /></span>
					
						<span class="property-value" aria-labelledby="uid-label"><g:fieldValue bean="${dictionaryInstance}" field="uid"/></span>
