...
<div id="mainContent" class="container-fluid">
    ...
    <g:render template="/geo/map_with_decisions"/>


    <div class="tooltip-actions" data-trigger="hover" data-placement="left" data-toggle="popover"
         title="<g:message code="homepage.tooltip.title" default="Instructions"/>"
...
//                        }
                    ...
                    for (index = 0; index < feature.p.features.length; ++index) {
                        ...
                        content.innerHTML = '<p style="font-size:12px">' + feature.p.features[index].p.namegrk + '</p>';
