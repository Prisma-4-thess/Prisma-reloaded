	...
	<body>
		...
		<div id="show-orgPosition" class="content scaffold-show" role="main">
			...
			<ol class="property-list orgPosition">
				...
				<g:if test="${orgPositionInstance?.uid}">
				<li class="fieldcontain">
					<span id="uid-label" class="property-label"><g:message code="orgPosition.uid.label" default="Uid" /></span>
					
						<span class="property-value" aria-labelledby="uid-label"><g:fieldValue bean="${orgPositionInstance}" field="uid"/></span>
