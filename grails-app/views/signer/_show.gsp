...
<div id="show-signer" class="content scaffold-show" role="main">
    <h1><g:message code="default.show.label" args="[entityName]" /> <g:fieldValue bean="${signerInstance}" field="firstName"/> <g:fieldValue bean="${signerInstance}" field="lastName"/></h1>
