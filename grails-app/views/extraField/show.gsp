	...
	<body>
		...
		<div id="show-extraField" class="content scaffold-show" role="main">
			...
			<ol class="property-list extraField">
				...
				<g:if test="${extraFieldInstance?.uid}">
				<li class="fieldcontain">
					<span id="uid-label" class="property-label"><g:message code="extraField.uid.label" default="Uid" /></span>
					
						<span class="property-value" aria-labelledby="uid-label"><g:fieldValue bean="${extraFieldInstance}" field="uid"/></span>
